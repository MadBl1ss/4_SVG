const tl = gsap.timeline({ defaults: { duration: .35, ease: "Power2.easeOut" } });
...
home.addEventListener('click', () => {
    ...
    gsap.fromTo('.feather',
        { y: -5, scale: 0 },
        { y: 20, scale: 1.5, duration: 1, stagger: .2 })
...
messages.addEventListener('click', () => {
    ...
    tl.fromTo('.note', { y: 0, opacity: 1 }, { y: -40, opacity: 0, duration: .75 })
